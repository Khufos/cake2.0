<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#submitInfProcList").click(function (event) {
                ...
                if (isset($processosAssistidosVinculados) && !empty($processosAssistidosVinculados)): ?>
    ...
    <div class="row">
        ...
        <div class="col-xs-6 col-md-6">
            <div class="form-group">
                ...
                $tipoAtividadeIdsEsc2 = isset($tipoAtividadeGroupedProcessual) ? $tipoAtividadeGroupedProcessual : '';
                if($tipoAtividadeIdsEsc2)$tipoAtividadeIdsEsc3 =array_keys($tipoAtividadeIdsEsc2);
                

                $args = array(
                    'class' => 'form-control input-sm selectMultiplo set-width-multiselect',
                    'empty' => 'Selecionar',
                    'default' => $tipoAtividadeIdsEsc3[0]
                );
                echo $this->Form->select("Lista_processo.tipogrupo_id", $tipoAtividadeGroupedProcessual, $args)
                ?>
            </div>
        </div>
...
<?php
    ...
    <script>
        ...
        $('#Lista_processoTipogrupoId').on('change', function () {
