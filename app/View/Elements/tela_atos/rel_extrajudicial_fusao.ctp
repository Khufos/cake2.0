        ...
        <div class="col-md-12">
            <div class="formlor">
                ...
                <div class="form-grouplor">
                    ...
                    echo $this->Form->select("Lista_processo2.tipoatividade_id", $tipoAtividadeGrouped["ATIV. EXTRAJUDICIAIS FINALISTICAS"], $args)
                    ?>
                </div>
    ...
    <table id="tabela-tipoatividademodal2" class="table color-table-white table-hover table-bordered " >
        ...
        <tr id="tr-<?= $value['ate']['id']; ?>">
            ...
            <?php
                ...
                echo $this->Html->link($this->Html->div('glyphicon glyphicon-pencil', ''), array(
                'controller' => 'atividade_extras',
                'action' => "show_modal_extrajudicial2/" .$value['ate']['id'] . "/" . "1"), array(
                'title' => 'Editar',
                'class' => 'buttonxzc',
                'data-target' => "#modal",
                'data-toggle' => "modal",
                'id' => "extr". $value['ate']['id'],
                'escape' => false
            ));
            ?>
