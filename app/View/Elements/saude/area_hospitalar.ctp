<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#SaudeTipoTransportesTipoTransportes").on("change click", function () { 
          var arr = [];
          $( "#SaudeTipoTransportesTipoTransportes option:selected" ).each(function() {
            arr.push($(this).text());
          });
        });
    ...
    <div class="col-md-3">
        <div class="form-group">
            <label>Tipo de Transporte:</label>
                <?php 
                echo $this->Form->select('SaudeTipoInternamentoHospitalar.tipo_transporte_id', $tipoTransporte, array('empty' => 'Selecione', 'class' => 'form-control input-sm transporte', 'value' => $this->Util->setaValorPadrao($tipoTransporteSel, null)));
                ?>
        </div>
    </div>
