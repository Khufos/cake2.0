<div id="enferm">
    ...
    if (!empty($this->data['Enfermidade'])) {

        ?>
        <?php
        foreach ($this->data['Enfermidade'] as $key => $value) {
//            ?>
...
//                                ?>
                        ...
                        <div class="col-xs-6 col-md-4">
                            <div class="form-group">
                                <label>CID:</label>
                                <?php
                                echo $this->Form->input("Enfermidade.$key.cid", array('class' => 'form-control input-sm',  'type' => 'text', 'label' => false, 
//                                    'value' => $value['Enfermidade']['cid']
                                        )
                                        );
//                                echo $this->Form->text("$modelAssocEnferm.$key.id", array('type' => 'hidden', 'value' => $value[$modelAssocEnferm]['id']));
                                echo $this->Form->text("Enfermidade.$key.id", array('type' => 'hidden', 
//                                    'value' => $value['Enfermidade']['id']
                                        ));
//                                ?>
                            </div>
                        </div>
                        <div class="col-xs-6 col-md-4">
                            <div class="form-group">
                                ...
                                <?php
                                echo $this->Form->select("Enfermidade.$key.grave", $simNao,array('empty' => 'Selecione', 'class' => 'form-control input-sm',  'type' => 'text', 'label' => false, 
//                                    'value' => $value['Enfermidade']['grave']
                                        ));
//                                ?>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xs-6 col-md-4">
                            <div class="form-group">
                                ...
                                <?php
                                echo $this->Form->input("Enfermidade.$key.prorrogacao",array('class' => 'form-control input-sm',  'type' => 'text', 'label' => false, 
//                                    'value' => $value['Enfermidade']['prorrogacao']
                                        ));
//                                ?>Ex.: 1 mês
                            </div>
                        </div>
