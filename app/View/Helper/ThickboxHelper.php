...
class ThickboxHelper extends AppHelper {
    ...
    function output(){
        ...
        $output = '<a title="'.$title.'" class="thickbox" href="'.$href.'">'.$previewContent.'</a>';
    ...
    function beforeRender(){
        $out = $this->Html->css('/effects/css/thickbox.css').'<script src="'.$this->Html->url('/effects/css/thickbox-compressed.js').'"></script>';
