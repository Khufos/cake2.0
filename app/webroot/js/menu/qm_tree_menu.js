    ...
    if(qmad){
        ...
        for(i in qmad){
            ...
            if(ss&&ss.tree_enabled){
                ...
                var wv='<style type="text/css">.qmistreestyles'+i+'{} #'+i+'{position:relative !important;} #'+i+' a{float:none !important;white-space:normal !important;position:static !important}#'+i+' div{width:auto !important;left:0px !important;top:0px !important;overflow:hidden !important;'+a2+az+'border-top-width:0px !important;border-bottom-width:0px !important;margin-left:0px !important;margin-top:0px !important;}';
...
function qm_tree_item_click(a,close){
    ...
    if(!a.qmtree&&!((z=window.qmv)&&z.loaded)){
        ...
        if(window.qmad&&qmad[id]&&qmad[id].tree_enabled)x2("qmfh",a,1);
        return;
    }
